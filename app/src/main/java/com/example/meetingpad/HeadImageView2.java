...
public class HeadImageView2 extends android.support.v7.widget.AppCompatImageView {
    ...
    public HeadImageView2(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        int bitmapSize = Math.min(bitmap.getWidth(), bitmap.getHeight());
    ...
    public HeadImageView2(Context context, AttributeSet attrs, int defStyleAttr) {
